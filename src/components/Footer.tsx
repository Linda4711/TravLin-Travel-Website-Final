...
export default function Footer({ onContactClick, onNavigateToServices, onNavigateToCruises, onNavigateToTravelOptions, onNavigateToStories, onNavigateToAbout, onNavigateToAI, onNavigateToHome, onNavigateToContact }: FooterProps) {
  ...
  // Footer subscription handler - placeholder for now
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div>
            <img 
              src={verticalLogo}
              alt="TravLin Travel"
              className="h-20 w-auto hover:scale-105 transition-transform duration-300 mb-2"
            />
            <h4 className="text-sm font-semibold text-white mb-2">ABOUT US</h4>
          ...
          <div>
            ...
            {/* Line 1: SUBSCRIBE title */}
            <p className="text-xs mb-1">
              <span className="font-semibold text-yellow-400">SUBSCRIBE</span>
            </p>
            
            {/* Line 2: Description */}
            <p className="text-xs text-gray-300 mb-2">
              Get exclusive travel deals and inspiration straight into your inbox
            </p>
            ...
            <div className="flex items-center justify-between text-xs">
              ...
              <button
                ...
                className="rounded p-1 h-6 w-6 flex-shrink-0"
          ...
          <div>
            <h4 className="text-sm font-semibold text-white mb-2">LET'S GO TRAVLIN</h4>
