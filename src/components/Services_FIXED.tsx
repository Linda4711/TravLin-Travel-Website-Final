...
const services = [
  ...
  },
  {
    ...
    description: 'Navigate visa requirements with ease through our expert guidance, document support, and access to reputable Visa Services.',
    color: '#0075CC'
  },
  {
    icon: FileText,
    title: 'Document Preparation & Delivery',
    description: 'Complete document handling electronic or hard copy including secure delivery methods or meetup.',
    color: '#ED7D31'
  }
]
...
export default function Services() {
  return (
    <section id="services" className="py-24 relative overflow-hidden" style={{ backgroundColor: 'var(--gray-50)' }}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        {/* SECTION HEADER - This was completely missing! */}
        <div className="text-center mb-20">
          <SectionDivider />
          <h2 className="section-heading">Our Services</h2>
          <p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
            From luxury cruises to customized independent travel, we offer comprehensive travel solutions 
            tailored to create your perfect journey.
          </p>
        </div>
