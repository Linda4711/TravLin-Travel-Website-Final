  ...
  const values = [
    {
      ...
      description: "Our business is a \"forever journey\". We thrive amidst global travel challenges and are tourism strong, genuinely caring for clients at every step as that extra layer of assurance and peace of mind."
    },
    {
      icon: Shield,
      title: "Award-winning",
      description: "As 2022 NTIA winners, we deliver proven excellence with meticulous attention to detail. Your peace of mind is our priority through secure, dependable arrangements you can trust."
    },
    {
      icon: Anchor,
      title: "Cruise Masters",
      description: "Cruise is our passion—ocean, river, expedition, luxury. As industry Cruise Masters, we continually enhance our expertise through product training in the fastest growing travel sector for Australians."
    },
    {
      icon: Heart,
      title: "Care and Support",
      description: "We treat you as family, bringing authentic passion and care to every interaction. Your travel dreams matter deeply to us, and we're committed to making them reality."
    },
    {
      icon: Car,
      title: "Mobile Meetup",
      description: "For complex itineraries, our mobile meetup service brings our expertise directly to you, simplifying planning and saving precious time so you can focus on what truly matters in life."
    },
    {
      icon: Phone,
      title: "24/7 Emergency",
      description: "We're here 24/7—emergency support ensures help is just a phone call away. Our commitment to your safety and comfort provides peace of mind before, during, and after your journey."
    },
    {
      icon: DollarSign,
      title: "Value for Money",
      description: "Listening to your needs allows us to craft the best value holiday that aligns perfectly with your requirements. Our goal is exceeding expectations while staying within budget to create your personalized dream getaway."
    },
    {
      icon: Camera,
      title: "Social Media Video",
      description: "As a special touch, we offer optional social media summary videos capturing the highlights of your TravLin journey. You are the reason we strive for exceptional service at every turn. Please ask for more info."
    }
  ]
